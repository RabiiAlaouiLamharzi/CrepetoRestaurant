...
public class SearchOrders extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("SEARCHORDERS"));
        ...
        jButton2.setText("Search By Order Code");
        ...
        jButton4.setText("Display All Orders");
        ...
        jButton6.setText("Search By Order Quantity");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        {
            String qry = "SELECT order_id, order_name, order_quantity, order_price, product_id "
            + " FROM Orders ";
            String order_id = jTextField4.getText();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
            ...
            Statement stmt = conn.createStatement())
        {
            String qry = "SELECT order_id, order_name, order_quantity, order_price, product_id "
            + " FROM Orders ";
            String order_quantity = jTextField2.getText();

            qry += " WHERE order_quantity = " + order_quantity;
