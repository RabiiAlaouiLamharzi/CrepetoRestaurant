...
public class SearchProducts extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("SEARCHPRODUCTS"));
        ...
        jButton2.setText("Search By Product Code");
        ...
        jButton6.setText("Search By Product Quantity");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        { 
        String qry = "SELECT product_id, product_name, product_quantity " 
        + " FROM Product "; 
        String product_id = jTextField4.getText(); 
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String qry = "SELECT product_id, product_name, product_quantity " 
        + " FROM Product "; 
        String product_quantity = jTextField2.getText(); 

        qry += " WHERE product_quantity = " + product_quantity; 
